            ...
            <div className="main" style={{paddingLeft:'7%', marginTop: '75px' }} >
                <MuiThemeProvider theme={THEME}>
                    ...
                    <div style={{ padding: 24, textAlign:'center'}}>
                        <Button size="large" style={{textAlign:'center'}} variant="contained" color="primary" onClick={this.viewCreate}>Add Video</Button>
                    </div>
                            ...
                            {this.state.submissions.map(submission => (
                                <Grid  key={submission.id}  item xs={12} sm={4} md={3} xl={3}>
                                    <Card style={{ padding: 10 }}>
                                        ...
                                        <CardActions>
                                            <Button size="small" color="primary" disabled={submission.state=='Waiting'} onClick={() => this.playVideo(submission.videoType, submission.videoId)}>
                                                Play video
                                            </Button>
                                        </CardActions>
                                    </Card>
