...
{/*                            <div className={classes.buttonDiv}>
                                <Button  size="large" variant="contained" color="primary" className={classes.button} onClick={this.props.toggleSignup}>
                    ...
                    <Grid  item xs={12} sm={4}>
                        <img  className={classes.imgBanner} src="assets/idea.jpg"/>
                    </Grid>
                    ...
                    {features.map(feature =>(
                        <Grid item xs={12} sm={4}>
                            <Paper className={classes.paper} elevation={1}>
                                <div >
                                    <img className={classes.img} src={feature.img}/>
                                </div>
